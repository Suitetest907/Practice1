...
({
     ...
     */
    events: {
        'click a[name=preview2_button]': 'customPreview'
    },
//    addActions: function() {
//        console.log("add action called");
//     },
//    DetaailPreviewEvent: function(){
//        thiss= this;
//      //this.context.on('button:preview1:click',this.abcd,this);
//      //this.context.on('button:preview2_button:click', this.abcd, this);
//          console.log("event triggered11");
//          //app.event.trigger('preview:render', model, this.collection, true);
//      //},this);  
//    },
   isPreviewOpen: false,
    customPreview: function(){
        ...
        thiss= this;
        var relateFieldLink = $('a[name=preview2_button]').attr("relateFieldValue");
        var splitedRelateFieldLink = relateFieldLink.split('/');
        var relid =  splitedRelateFieldLink[1];
        var moduleName = splitedRelateFieldLink[0].replace(/[^a-z0-9\s]/gi, '').replace(/[_\s]/g, '-');
        ...
        var indust= account.get('industry');
        var accountCollection = app.data.createBeanCollection(moduleName, [account]);
        if (this.isPreviewOpen) {
            app.events.trigger('preview:close');
            this.isPreviewOpen = false;

        } else {
        app.events.trigger("preview:render", account, accountCollection, false);
