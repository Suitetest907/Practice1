...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'No s\'ha trobat: El Planificador de Sugar tindrà funcionalitat limitada. El servei d\'arxivament de correu electrònic no funcionarà.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No s\'ha trobat el suport de la base de dades. Assegureu-vos que teniu els controladors necessaris per a un dels següents tipus de bases de dades suportades: MySQL, MS SQLServer, Oracle o DB2.  Podrieu necessitar treure la marca de comentari de l\'extensió del fitxer php. ini, o recompilar amb l\'arxiu binari correcte, depenent de la versió de PHP.  Consulteu el manual de PHP per obtenir més informació sobre com habilitar el suport de la base de dades.',
